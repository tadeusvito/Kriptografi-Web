...
$query = "SELECT id_acc3, file, kunci FROM files";
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item px-2">
                        <a class="nav-link text-white active" href="lihatfile.php">File</a>
                    </li>
                </ul>
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item px-2">
                ...
                <table class="table table-bordered table-striped align-middle">
                    ...
                    <tbody>
                        <?php while ($data = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                <!-- ID Acc column -->
                                <td><?= htmlspecialchars($data['id_acc3']) ?></td>

                                <!-- Encrypted File column -->
                                <td>
                                    <?php if (!empty($data['file'])): ?>
                                        <textarea class="form-control" rows="5" readonly>
                                            <?= htmlspecialchars(substr(base64_encode($data['file']), 0, 100)) ?>...
                                        </textarea>
                                    <?php else: ?>
                                        <p>No File Data</p>
                                    <?php endif; ?>
                                ...
                                <!-- Key column -->
                                <td>
                                    <?= htmlspecialchars(substr($data['kunci'], 0, 20)) ?>...
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
