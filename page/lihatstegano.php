...
// Query to fetch encrypted images
$query = "SELECT id_acc2, gambar FROM stegano";
...
<head>
    ...
    <title>View Encrypted Images</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item px-2">
                        <a class="nav-link text-white active" href="lihatstegano.php">Stegano Pict</a>
                    </li>
                    <li class="nav-item px-2">
    ...
    <div class="container my-3">
        <h2 class="mb-4 text-center">Encrypted Images</h2>
                ...
                <table class="table table-bordered table-striped align-middle">
                    ...
                    <tbody>
                        <?php while ($data = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                <!-- ID Acc column -->
                                <td><?= htmlspecialchars($data['id_acc2']) ?></td>

                                <!-- Encrypted Image column -->
                                <td>
                                    <?php if (!empty($data['gambar'])): ?>
                                        <img src="data:image/png;base64,<?= htmlspecialchars($data['gambar']) ?>" alt="Encrypted Image" width="150">
                                    <?php else: ?>
        ...
        <?php else: ?>
            <div class="alert alert-warning text-center">
                <p>No encrypted images found in the database.</p>
            </div>
        <?php endif; ?>
    </div>
